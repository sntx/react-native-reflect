...
---
The example below demonstrates how theme-based responsive style sheets work. Run the [Reflect Examples Expo App](https://github.com/lucidolab/reflect/blob/master/examples/all-examples) and follow the comments in the code:
...
```
Run all examples by installing the [Reflect Examples Expo App](https://github.com/lucidolab/reflect/blob/master/examples/all-examples)
...
---
The example below demonstrates how to define multiple theme-based, responsive style props. Run the [Reflect Examples Expo App](https://github.com/lucidolab/reflect/blob/master/examples/all-examples) and follow the comments in the code:
...
```
Run all examples with the [Reflect Examples Expo App](https://github.com/lucidolab/reflect/blob/master/examples/all-examples)
...
```
Run the example above and all other example with the [Reflect Examples Expo App](https://github.com/lucidolab/reflect/blob/master/examples/all-examples)
...
```javascript
import { useStyled } from "@lucido/reflect";
...
```javascript
import { defaultTheme } from "@lucido/reflect";
console.log(defaultTheme);
```
...
```javascript
import { ThemeProvider, defaultTheme } from "@lucido/reflect";
